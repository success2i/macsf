 ...
 */
 var i=0;
Ext.define('SenchaCoverFlow.model.Loan', {
    ...
    config: {
        fields: [
            ...
            {name: "image", type: "string", mapping: "image.id", convert: function(value, record) {i+=1;
                return "http://127.0.0.1:8080/v1/resources/images/"+i+".jpg";
            }},
            'terms', 'location',
            {
