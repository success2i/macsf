...
Ext.define('SenchaCoverFlow.view.LoansListItem', {
    extend: 'Ext.dataview.component.DataItem',
    xtype : 'loanslistitem',
    requires: ['Ext.Img', 'SenchaCoverFlow.view.LoansListItemCompletion'],
    ...
    applyCompletion: function(config) {
        return Ext.factory(config, SenchaCoverFlow.view.LoansListItemCompletion, this.getCompletion());
    },
